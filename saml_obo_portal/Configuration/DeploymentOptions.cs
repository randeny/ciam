...
public sealed class PortalLogonOptions
{
    ...
    /// <summary>Tenant subdomain used to reach the native-auth host (e.g. "gayant2" -> gayant2.ciamlogin.com).</summary>
    public string TenantSubdomain { get; set; } = string.Empty;

    /// <summary>Host used to reach the native-auth endpoints (e.g. "extid.mydom.me" custom domain).</summary>
    public string NativeAuthHost { get; set; } = "extid.mydom.me";
